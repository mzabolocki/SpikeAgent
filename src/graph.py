...
gpt_4o = ChatOpenAI(model_name="gpt-4o", temperature=0).bind_tools(tools, parallel_tool_calls=True)
gpt_4o_mini = ChatOpenAI(model_name="gpt-4o-mini", temperature=0).bind_tools(tools, parallel_tool_calls=True)
o1 = ChatOpenAI(model_name="o1").bind_tools(tools)
gpt_4_turbo = ChatOpenAI(model_name="gpt-4-turbo", temperature=0).bind_tools(tools, parallel_tool_calls=True)
gpt_3_5_turbo = ChatOpenAI(model_name="gpt-3.5-turbo", temperature=0).bind_tools(tools, parallel_tool_calls=True)
